...
import C2CarouselView from '../c2components/carousel';
import {useRoute} from '@react-navigation/native';

function C2ResolvedScreen2({navigation}) {
  ...
  async function unresolve() {
    ...
    const record = await pb.collection('issues2').update(id, formData);
    if (record) {
  ...
  return (
    <ScrollView>
      ...
      <View
        ...
        <C2CarouselView images={data.images} id={data.id} />
      </View>
...
export default C2ResolvedScreen2;
